...
var maxDurationMessage = "Attention à la durée @%pseudo%, essayes d'éviter les musiques de plus de %maxDurationOfficial% minutes pour le confort de tous !:)";

var earlyLevel = 2;// Under this level you are considered as a newbie
var earlyLevelMessage = "Bienvenue @%pseudo% si tu as des questions n'hésites pas à t'adresser aux modérateurs présents !";

var autoMsgCycling = 15;// in Minutes
var autoMsgCyclingMessage = "Petit rappel : la durée maximale toléré pour une musique est de %maxDurationOfficial% minutes, essayez de respecter cette durée, merci !";
